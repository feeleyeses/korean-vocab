...
function normalizeCard(){
  ...
  const mobile=matchMedia('(max-width:900px)').matches, cardH='500px', wordH=mobile?'132px':'136px', actionH=mobile?'50px':'52px', actionX=mobile?'14px':'24px', continueW='180px', contentInset=mobile?14:22, nestedActionX=`max(0px, calc(${actionX} - ${contentInset}px))`, nestedActionW=`calc(100% - (2 * ${nestedActionX}))`;
