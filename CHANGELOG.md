...
- Specific Mobile Regression Follow-up: aligned the browser smoke check with the removed mobile learning-rule entry and locked mobile polysemy secondary buttons to the compact two-column height used by the consistency audit, with no vocabulary expansion.
